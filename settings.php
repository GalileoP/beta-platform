...
<html lang="en">
    ...
    <body>
        ...
        <div class='tes'><div class="sredina"><img src='<?=$steamprofile['avatarmedium']?>'></div><div class="ime"><?=$steamprofile['personaname']?></div><div class="logout_button"><?php logoutbutton(); ?></div></div>
    </body>
</html>
<?php
}    
